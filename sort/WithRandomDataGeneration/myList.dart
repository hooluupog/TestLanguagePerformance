...
class _SubMyList<E> extends Object with ListMixin<E> {
  final List<E> _source;
  final int _offset;
  final int _length;

  _SubMyList(this._source, int offset, int fromIndex, int toIndex)
  ...
  List<E> subList(int fromIndex, [int toIndex]) {
    ...
    return new _SubMyList(_source, _offset, fromIndex, end);
  }
}
...
class MyList<E> extends Object with ListMixin<E> implements List<E> {
  ...
  List<E> subList(int fromIndex, [int toIndex]) {
    ...
    return new _SubMyList(_source, 0, fromIndex, length);
  }
